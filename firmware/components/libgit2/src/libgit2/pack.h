...
/* BYOK: desktop defaults (16 MB budget, 1 MB/entry) exhausted our 2 MB PSRAM while resolving a
 * long delta chain (~40 versions of a 190 KB manuscript) -> "Out of memory" on a 444 KB pack.
 * Cache a little, re-inflate the rest; the SD-backed pack windows are cheap by comparison. */
#define GIT_PACK_CACHE_MEMORY_LIMIT 256 * 1024
#define GIT_PACK_CACHE_SIZE_LIMIT 128 * 1024 /* don't bother caching anything over 128KB */
